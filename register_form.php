  ...
  <div class="container h-100">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-lg-12 col-xl-11">
        <div class="card text-black bg-warning" style="border-radius: 25px;">
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">

                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">สร้างบัญชี</p>
                ...
                <form class="mx-1 mx-md-4" method="POST" action="check_regis.php" enctype="multipart/form-data">
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button type="button" class="btn btn-primary btn-lg">ลงทะเบียน</button>
                  </div>
              ...
              <!--<div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">-->
               ...
               <!-- <img src="img/img4.webp" class="img-fluid" alt="Sample image">-->
